const HOLIDAYS = [
  ...
  { id: "passover",     name: "פסח",           emoji: "🐪", status: "חג פסר כשר ושמח! 🐪",
    ranges: [{ s: [2026,4,1], e: [2026,4,9] }, { s: [2027,4,21], e: [2027,4,29] }] },
  { id: "shavuot",      name: "שבועות",        emoji: "🌸", status: "🌸 חג שבועות שמח!",
    ranges: [{ s: [2026,5,21], e: [2026,5,23] }, { s: [2027,6,9], e: [2027,6,11] }] },
  { id: "independence", name: "יום העצמאות",   emoji: "🇮🇱", status: "🇮🇱 יום העצמאות שמח!",
    ranges: [{ s: [2026,4,20], e: [2026,4,21] }, { s: [2027,5,9], e: [2027,5,10] }] },
